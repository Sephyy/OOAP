...
//****************************************************************************************
require 'path.php';
init_cobalt('View advertiser');

$page_title       = 'ListView: %%';
$db_subclass      = 'advertiser';
$html_subclass    = 'advertiser_html';
$arr_pkey_name    = array('advertiser_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add advertiser';
$edit_link        = 'Edit advertiser';
$delete_link      = 'Delete advertiser';
$view_link        = 'View advertiser';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_advertiser.php';
$edit_page        = 'edit_advertiser.php';
$delete_page      = 'delete_advertiser.php';
$view_page        = 'detailview_advertiser.php';
$csv_page         = 'csv_advertiser.php';
$report_page      = 'reporter_advertiser.php';
