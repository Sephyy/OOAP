...
//****************************************************************************************
require 'path.php';
init_cobalt('View question');

$page_title       = 'ListView: %%';
$db_subclass      = 'question';
$html_subclass    = 'question_html';
$arr_pkey_name    = array('question_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add question';
$edit_link        = 'Edit question';
$delete_link      = 'Delete question';
$view_link        = 'View question';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_question.php';
$edit_page        = 'edit_question.php';
$delete_page      = 'delete_question.php';
$view_page        = 'detailview_question.php';
$csv_page         = 'csv_question.php';
$report_page      = 'reporter_question.php';
