...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel'])
    {
        ...
        redirect("listview_player_answered_question.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_player_answered_question_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_player_answered_question->export_to_csv();
