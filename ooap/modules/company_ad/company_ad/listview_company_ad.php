...
$page_title       = 'ListView: %%';
$db_subclass      = 'company_ad';
$html_subclass    = 'company_ad_html';
$arr_pkey_name    = array('company_ad_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add company ad';
$edit_link        = 'Edit company ad';
$delete_link      = 'Delete company ad';
$view_link        = 'View company ad';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_company_ad.php';
$edit_page        = 'edit_company_ad.php';
$delete_page      = 'delete_company_ad.php';
$view_page        = 'detailview_company_ad.php';
$csv_page         = 'csv_company_ad.php';
$report_page      = 'reporter_company_ad.php';
