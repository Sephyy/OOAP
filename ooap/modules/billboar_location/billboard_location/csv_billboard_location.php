...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel'])
    {
        ...
        redirect("listview_billboard_location.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_billboard_location_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_billboard_location->export_to_csv();
