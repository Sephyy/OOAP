...
//****************************************************************************************
require 'path.php';
init_cobalt('View trivia');

$page_title       = 'ListView: %%';
$db_subclass      = 'trivia';
$html_subclass    = 'trivia_html';
$arr_pkey_name    = array('trivia_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add trivia';
$edit_link        = 'Edit trivia';
$delete_link      = 'Delete trivia';
$view_link        = 'View trivia';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_trivia.php';
$edit_page        = 'edit_trivia.php';
$delete_page      = 'delete_trivia.php';
$view_page        = 'detailview_trivia.php';
$csv_page         = 'csv_trivia.php';
$report_page      = 'reporter_trivia.php';
