...
$page_title       = 'ListView: %%';
$db_subclass      = 'player_answered_question';
$html_subclass    = 'player_answered_question_html';
$arr_pkey_name    = array('player_answered_question_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add player answered question';
$edit_link        = 'Edit player answered question';
$delete_link      = 'Delete player answered question';
$view_link        = 'View player answered question';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_player_answered_question.php';
$edit_page        = 'edit_player_answered_question.php';
$delete_page      = 'delete_player_answered_question.php';
$view_page        = 'detailview_player_answered_question.php';
$csv_page         = 'csv_player_answered_question.php';
$report_page      = 'reporter_player_answered_question.php';
