...
//****************************************************************************************
require 'path.php';
init_cobalt('View player');

$page_title       = 'ListView: %%';
$db_subclass      = 'player';
$html_subclass    = 'player_html';
$arr_pkey_name    = array('player_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add player';
$edit_link        = 'Edit player';
$delete_link      = 'Delete player';
$view_link        = 'View player';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_player.php';
$edit_page        = 'edit_player.php';
$delete_page      = 'delete_player.php';
$view_page        = 'detailview_player.php';
$csv_page         = 'csv_player.php';
$report_page      = 'reporter_player.php';
