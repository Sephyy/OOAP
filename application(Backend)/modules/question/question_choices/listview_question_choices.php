...
$page_title       = 'ListView: %%';
$db_subclass      = 'question_choices';
$html_subclass    = 'question_choices_html';
$arr_pkey_name    = array('question_choices_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add question choices';
$edit_link        = 'Edit question choices';
$delete_link      = 'Delete question choices';
$view_link        = 'View question choices';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_question_choices.php';
$edit_page        = 'edit_question_choices.php';
$delete_page      = 'delete_question_choices.php';
$view_page        = 'detailview_question_choices.php';
$csv_page         = 'csv_question_choices.php';
$report_page      = 'reporter_question_choices.php';
