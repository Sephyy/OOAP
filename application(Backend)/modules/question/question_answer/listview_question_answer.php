...
//****************************************************************************************
require 'path.php';
init_cobalt('View question answer');

$page_title       = 'ListView: %%';
$db_subclass      = 'question_answer';
$html_subclass    = 'question_answer_html';
$arr_pkey_name    = array('question_answer_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add question answer';
$edit_link        = 'Edit question answer';
$delete_link      = 'Delete question answer';
$view_link        = 'View question answer';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_question_answer.php';
$edit_page        = 'edit_question_answer.php';
$delete_page      = 'delete_question_answer.php';
$view_page        = 'detailview_question_answer.php';
$csv_page         = 'csv_question_answer.php';
$report_page      = 'reporter_question_answer.php';
